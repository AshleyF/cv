...
\section{Microsoft Research{\small, 23+ years total (2024)}}

\cventry{\large 2016--{\small Present}}{Principal Research SDE}{}{}{}{
Machine learning tools and reactive system infrastructure, with ROS and Python bridge, applied to robotic and human interaction scenarios. For example, LLM-driven ``Dittos'' in Teams meetings. The Platform for Situated Intelligence (aka \textbackslash psi, aka $\psi$) project under Eric Horvitz.}
\vspace{3pt}

\cvline{\scriptsize LLM Ditto}{
    \begin{itemize}
        \item Built infrastructure for LLM-driven ``Ditto'' avatars in Teams meetings {\tiny (LLM)}
        \item Invented pure functional game-loop style deterministic debugger for \textbackslash psi pipelines {\tiny (\textbackslash psi)}
        \item Wrote incremental streaming LLM response parser; replacing Newtonsoft {\tiny (LLM F\# JSON)}
    \end{itemize}
    \vspace*{-\baselineskip}}

\cvline{\scriptsize HoloLens}{
    \begin{itemize}
        \item Created HoloLens app to gather real world human interaction dataset {\tiny (HoloLens StereoKit 3D)}
        \item Published paper and dataset along with open source support for HoloLens in \textbackslash psi for HoloLens
        \item Built tools to consume \textbackslash psi data stores in Python {\tiny (\textbackslash psi Python)}
        \item Made PyTorch library for \textbackslash psi (aka ``PsiTorch'') {\tiny (\textbackslash psi PyTorch)}
    \end{itemize}
    \vspace*{-\baselineskip}}

\cvline{\scriptsize Robotics}{
    \begin{itemize}
        \item Built several robots, including an indoor navigating directions robot, SightSign arm for Steve Gleason, Go playing arm, ...
        \item Implemented a ROS bridge library between \textbackslash psi (Windows) and ROS (Linux)
        \item Delivered many presentations (to executives [Harry Shum, Amy Hood, Eric Horvitz, ...], for \textbackslash psi workshops and webinars, ``Robotics Day'' at MSR, ...
    \end{itemize}
    \vspace*{-\baselineskip}}

\cvline{\scriptsize Platform}{
    \begin{itemize}
        \item Built ML feature extraction and training pipeline, PyTorch integration, an F\#-based DSL, ... {\tiny (F# PyTorch)}
        \item Build a Python bridge and \textbackslash psi store reader for Python.
        \item Implemented cross-machine remoting (custom protocol and serialization) for \textbackslash psi
        \item Ported runtime to Linux (including Jetson TX1 board, Raspberry Pi, ...)
...
\cventry{2023}{HoloAssist: an Egocentric Human Interaction Dataset for Interactive AI Assistants in the Real World}{ICCV}{}{}{}
\cventry{2022}{Continual Learning about Objects in the Wild: An Interactive Approach}{ICMI}{}{}{}
\cventry{2021}{Platform for Situated Intelligence}{ArXiv}{}{}{}
\cventry{2019}{Demonstrating a Framework for Rapid Development of Physically Situated Interactive Systems}{HRI}{}{}{}
